...
flowchart LR
    ...
    Qudi_Examples_SimpleUsage_Azumarill["Azumarill"]
    ...
    Qudi_Examples_SimpleUsage_IPokemon --> Qudi_Examples_SimpleUsage_Azumarill
    ...
    class Qudi_Examples_SimpleUsage_Azumarill cls;
